...
| 版本 | 日期 | 更新内容 |
|------|------|----------|
| v2.0.0 | 2025-12-11 | 新增 user_summary 字段自动生成功能 (v2.5.4) |
...
3. **数据存储结构**:
   ...
   // user_archives 集合
   {
     ...
     "items_count": 3,
     // v2.5.2: AI生成的摘要报告
     "generated_report": "# 西藏相关新闻汇总\n\n## 核心要点\n...",
     // v2.5.4: 自动生成的档案条目汇总 (Markdown格式)
     "user_summary": "# 西藏相关新闻汇总\n\n## 1. 留学生因支持藏人被捕\n来源: xxx\n内容预览...\n\n---\n\n## 2. ...",
     "created_at": ISODate("..."),
     "updated_at": ISODate("...")
   }
   ```

4. **user_summary 字段说明 (v2.5.4)**:
   - **自动生成**: 创建档案时自动根据所有条目生成 Markdown 格式的汇总
   - **格式结构**:
     ```markdown
     # {档案名称}
     ...
     ```
   - **用途**: 前端导出、预览、AI分析时使用
   - **可编辑**: 用户可通过 PUT API 手动修改 user_summary
...
```json
{
  ...
  "generated_report": "# 西藏相关新闻汇总\n\n## 核心要点\n...",  // v2.5.2: AI生成报告
  "user_summary": "# 西藏相关新闻汇总\n\n## 1. 留学生因支持藏人被捕\n来源: chineseyouthstandfortibet.substack.com\n张雅笛原定到英国伦敦...\n\n---\n",  // v2.5.4: 自动生成汇总
  "created_at": "2025-11-22T10:00:00Z",
  "updated_at": "2025-11-22T10:00:00Z"
}
```
